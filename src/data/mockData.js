export function generateSeedData() {
  ...
  // Exactly 1 Pristine Accurate Image Per Product (1200px Unsplash 200 OK)
  const product_images = [
    { id: 'img-1', product_id: p1, url: 'https://images.unsplash.com/photo-1617806118233-18e1de247200?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-2', product_id: p2, url: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-3', product_id: p3, url: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-4', product_id: p4, url: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-5', product_id: p5, url: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-6', product_id: p6, url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-7', product_id: p7, url: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-8', product_id: p8, url: 'https://images.unsplash.com/photo-1558882224-dda166733046?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-9', product_id: p9, url: 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-10', product_id: p10, url: 'https://images.unsplash.com/photo-1505797149-43b0069ec26b?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
    { id: 'img-11', product_id: p11, url: 'https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1200&auto=format&fit=crop', sort_order: 0 },
  ];
